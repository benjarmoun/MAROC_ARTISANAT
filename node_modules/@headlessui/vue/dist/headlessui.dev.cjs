...
var Hidden = (0, import_vue6.defineComponent)({
  name: "Hidden",
  props: {
  ...
  setup(props, { slots, attrs, emit }) {
      ...
      openCombobox() {
        ...
        let optionIdx = options.value.findIndex((option) => {
          ...
          let selected = match(mode.value, {
            [0 /* Single */]: () => api.compare((0, import_vue7.toRaw)(api.value.value), (0, import_vue7.toRaw)(optionValue)),
            [1 /* Multi */]: () => (0, import_vue7.toRaw)(api.value.value).some((value2) => api.compare((0, import_vue7.toRaw)(value2), (0, import_vue7.toRaw)(optionValue)))
          });
          return selected;
        });
        if (optionIdx !== -1) {
    ...
    return () => {
      ...
      return (0, import_vue7.h)(import_vue7.Fragment, [
        ...name != null && modelValue != null ? objectToFormEntries({ [name]: modelValue }).map(([name2, value2]) => (0, import_vue7.h)(Hidden, compact({
          features: 4 /* Hidden */,
          key: name2,
          as: "input",
          type: "hidden",
...
var ComboboxOption = (0, import_vue7.defineComponent)({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    let selected = (0, import_vue7.computed)(() => match(api.mode.value, {
      [0 /* Single */]: () => api.compare((0, import_vue7.toRaw)(api.value.value), (0, import_vue7.toRaw)(props.value)),
      [1 /* Multi */]: () => (0, import_vue7.toRaw)(api.value.value).some((value) => api.compare((0, import_vue7.toRaw)(value), (0, import_vue7.toRaw)(props.value)))
    }));
...
function useTabDirection() {
  let direction = (0, import_vue8.ref)(0 /* Forwards */);
...
var FocusTrap = Object.assign((0, import_vue10.defineComponent)({
  name: "FocusTrap",
  props: {
    as: { type: [Object, String], default: "div" },
    ...
    containers: {
      type: Object,
      default: (0, import_vue10.ref)(/* @__PURE__ */ new Set())
    }
  },
  inheritAttrs: false,
  setup(props, { attrs, slots, expose }) {
    let container = (0, import_vue10.ref)(null);
    expose({ el: container, $el: container });
    let ownerDocument = (0, import_vue10.computed)(() => getOwnerDocument(container));
    useRestoreFocus({ ownerDocument }, (0, import_vue10.computed)(() => Boolean(props.features & 16 /* RestoreFocus */)));
    let previousActiveElement = useInitialFocus({ ownerDocument, container, initialFocus: (0, import_vue10.computed)(() => props.initialFocus) }, (0, import_vue10.computed)(() => Boolean(props.features & 2 /* InitialFocus */)));
    useFocusLock({
      ownerDocument,
      container,
      containers: props.containers,
      previousActiveElement
    }, (0, import_vue10.computed)(() => Boolean(props.features & 8 /* FocusLock */)));
    ...
    return () => {
      ...
      return (0, import_vue10.h)(import_vue10.Fragment, [
        Boolean(features & 4 /* TabLock */) && (0, import_vue10.h)(Hidden, {
          as: "button",
          type: "button",
          onFocus: handleFocus,
...
function useRestoreFocus({ ownerDocument }, enabled) {
  let restoreElement = (0, import_vue10.ref)(null);
  let mounted = { value: false };
  (0, import_vue10.onMounted)(() => {
    (0, import_vue10.watch)(enabled, (newValue, prevValue) => {
      var _a;
    ...
    (0, import_vue10.watch)(enabled, (newValue, prevValue, onInvalidate) => {
      if (newValue === prevValue)
        return;
      if (!enabled.value)
        return;
...
function useInitialFocus({
  ...
  let previousActiveElement = (0, import_vue10.ref)(null);
  (0, import_vue10.onMounted)(() => {
    (0, import_vue10.watch)([container, initialFocus, enabled], (newValues, prevValues) => {
      var _a, _b;
...
function useInertOthers(container, enabled = (0, import_vue11.ref)(true)) {
...
function usePortalRoot() {
  return (0, import_vue12.inject)(ForcePortalRootContext, false);
}
var ForcePortalRoot = (0, import_vue12.defineComponent)({
  ...
  setup(props, { slots, attrs }) {
    (0, import_vue12.provide)(ForcePortalRootContext, props.force);
    return () => {
...
var Portal = (0, import_vue13.defineComponent)({
  name: "Portal",
  props: {
    as: { type: [Object, String], default: "div" }
  },
  setup(props, { slots, attrs }) {
    let element = (0, import_vue13.ref)(null);
    let ownerDocument = (0, import_vue13.computed)(() => getOwnerDocument(element));
    let forcePortalRoot = usePortalRoot();
    let groupContext = (0, import_vue13.inject)(PortalGroupContext, null);
    let myTarget = (0, import_vue13.ref)(forcePortalRoot === true ? getPortalRoot(element.value) : groupContext == null ? getPortalRoot(element.value) : groupContext.resolveTarget());
    ...
    return () => {
      ...
      return (0, import_vue13.h)(import_vue13.Teleport, { to: myTarget.value }, render({
        props: { ...props, ...ourProps },
        slot: {},
        attrs,
        slots,
...
var PortalGroup = (0, import_vue13.defineComponent)({
  name: "PortalGroup",
  props: {
    as: { type: [Object, String], default: "template" },
  ...
  setup(props, { attrs, slots }) {
    let api = (0, import_vue13.reactive)({
      resolveTarget() {
        return props.target;
      }
    });
    (0, import_vue13.provide)(PortalGroupContext, api);
    return () => {
...
function useStackContext() {
  return (0, import_vue14.inject)(StackContext, () => {
  });
}
function useStackProvider({
  ...
  (0, import_vue14.provide)(StackContext, notify);
}
...
function useDescriptionContext() {
  let context = (0, import_vue15.inject)(DescriptionContext, null);
  if (context === null) {
...
function useDescriptions({
  slot = (0, import_vue15.ref)({}),
  name = "Description",
  props = {}
} = {}) {
  let descriptionIds = (0, import_vue15.ref)([]);
  ...
  (0, import_vue15.provide)(DescriptionContext, { register, slot, name, props });
  return (0, import_vue15.computed)(() => descriptionIds.value.length > 0 ? descriptionIds.value.join(" ") : void 0);
}
var Description = (0, import_vue15.defineComponent)({
  name: "Description",
  props: {
  ...
  setup(myProps, { attrs, slots }) {
    ...
    (0, import_vue15.onMounted)(() => (0, import_vue15.onUnmounted)(context.register(id2)));
    return () => {
      let { name = "Description", slot = (0, import_vue15.ref)({}), props = {} } = context;
      let incomingProps = myProps;
      let ourProps = {
        ...Object.entries(props).reduce((acc, [key, value]) => Object.assign(acc, { [key]: (0, import_vue15.unref)(value) }), {}),
        id: id2
      };
      return render({
        props: { ...incomingProps, ...ourProps },
...
function useDialogContext(component) {
  let context = (0, import_vue16.inject)(DialogContext, null);
  if (context === null) {
...
var Dialog = (0, import_vue16.defineComponent)({
  name: "Dialog",
  inheritAttrs: false,
  props: {
    as: { type: [Object, String], default: "div" },
  ...
  setup(props, { emit, attrs, slots, expose }) {
    var _a;
    let nestedDialogCount = (0, import_vue16.ref)(0);
    let usesOpenClosedState = useOpenClosed();
    let open = (0, import_vue16.computed)(() => {
    ...
    let containers = (0, import_vue16.ref)(/* @__PURE__ */ new Set());
    let internalDialogRef = (0, import_vue16.ref)(null);
    let mainTreeNode = (0, import_vue16.ref)(null);
    let ownerDocument = (0, import_vue16.computed)(() => getOwnerDocument(internalDialogRef));
    ...
    let dialogState = (0, import_vue16.computed)(() => open.value ? 0 /* Open */ : 1 /* Closed */);
    let enabled = (0, import_vue16.computed)(() => dialogState.value === 0 /* Open */);
    let hasNestedDialogs = (0, import_vue16.computed)(() => nestedDialogCount.value > 1);
    let hasParentDialog = (0, import_vue16.inject)(DialogContext, null) !== null;
    let position = (0, import_vue16.computed)(() => !hasNestedDialogs.value ? "leaf" : "parent");
    useInertOthers(internalDialogRef, (0, import_vue16.computed)(() => hasNestedDialogs.value ? enabled.value : false));
    useStackProvider({
      type: "Dialog",
    ...
    let describedby = useDescriptions({
      ...
      slot: (0, import_vue16.computed)(() => ({ open: open.value }))
    });
    let id2 = `headlessui-dialog-${useId()}`;
    let titleId = (0, import_vue16.ref)(null);
    let api = {
      titleId,
      panelRef: (0, import_vue16.ref)(null),
      dialogState,
      setTitleId(id3) {
    ...
    (0, import_vue16.provide)(DialogContext, api);
    useOutsideClick(() => {
      var _a2, _b, _c;
      ...
      if (hasNestedDialogs.value)
        return;
      api.close();
      (0, import_vue16.nextTick)(() => target == null ? void 0 : target.focus());
    }, 2 /* IgnoreScrollbars */);
    ...
    return () => {
      ...
      return (0, import_vue16.h)(ForcePortalRoot, { force: true }, () => [
        (0, import_vue16.h)(Portal, () => (0, import_vue16.h)(PortalGroup, { target: internalDialogRef.value }, () => (0, import_vue16.h)(ForcePortalRoot, { force: false }, () => (0, import_vue16.h)(FocusTrap, {
          initialFocus,
          containers,
        ...
        (0, import_vue16.h)(Hidden, { features: 4 /* Hidden */, ref: mainTreeNode })
      ]);
    };
  }
});
var DialogOverlay = (0, import_vue16.defineComponent)({
  name: "DialogOverlay",
  props: {
    as: { type: [Object, String], default: "div" }
  },
...
var DialogBackdrop = (0, import_vue16.defineComponent)({
  name: "DialogBackdrop",
  props: {
    as: { type: [Object, String], default: "div" }
  },
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let internalBackdropRef = (0, import_vue16.ref)(null);
    ...
    return () => {
      ...
      return (0, import_vue16.h)(ForcePortalRoot, { force: true }, () => (0, import_vue16.h)(Portal, () => render({
        props: { ...attrs, ...incomingProps, ...ourProps },
        slot: { open: api.dialogState.value === 0 /* Open */ },
        attrs,
        slots,
...
var DialogPanel = (0, import_vue16.defineComponent)({
  name: "DialogPanel",
  props: {
    as: { type: [Object, String], default: "div" }
  },
...
var DialogTitle = (0, import_vue16.defineComponent)({
  name: "DialogTitle",
  props: {
  ...
  setup(props, { attrs, slots }) {
    ...
    (0, import_vue16.onMounted)(() => {
      api.setTitleId(id2);
      (0, import_vue16.onUnmounted)(() => api.setTitleId(null));
    });
    return () => {
      let ourProps = { id: id2 };
      let incomingProps = props;
...
function useDisclosureContext(component) {
  let context = (0, import_vue17.inject)(DisclosureContext, null);
  if (context === null) {
...
function useDisclosurePanelContext() {
  return (0, import_vue17.inject)(DisclosurePanelContext, null);
}
var Disclosure = (0, import_vue17.defineComponent)({
  name: "Disclosure",
  props: {
    as: { type: [Object, String], default: "template" },
  ...
  setup(props, { slots, attrs }) {
    ...
    let disclosureState = (0, import_vue17.ref)(props.defaultOpen ? 0 /* Open */ : 1 /* Closed */);
    let panelRef = (0, import_vue17.ref)(null);
    ...
    (0, import_vue17.provide)(DisclosureContext, api);
    useOpenClosedProvider((0, import_vue17.computed)(() => {
...
var DisclosureButton = (0, import_vue17.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let internalButtonRef = (0, import_vue17.ref)(null);
    ...
    let type = useResolveButtonType((0, import_vue17.computed)(() => ({ as: props.as, type: attrs.type })), internalButtonRef);
    function handleClick() {
      var _a;
      if (props.disabled)
        return;
...
var DisclosurePanel = (0, import_vue17.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    (0, import_vue17.provide)(DisclosurePanelContext, api.panelId);
    let usesOpenClosedState = useOpenClosed();
  ...
  setup(props, { slots, attrs, emit }) {
      ...
      select(value2) {
        ...
        emit("update:modelValue", match(mode.value, {
          ...
          [1 /* Multi */]: () => {
            ...
            let idx = copy.findIndex((value3) => api.compare(raw, (0, import_vue18.toRaw)(value3)));
            if (idx === -1) {
              copy.push(raw);
            } else {
              copy.splice(idx, 1);
    ...
    return () => {
      ...
      return (0, import_vue18.h)(import_vue18.Fragment, [
        ...name != null && modelValue != null ? objectToFormEntries({ [name]: modelValue }).map(([name2, value2]) => (0, import_vue18.h)(Hidden, compact({
          features: 4 /* Hidden */,
          key: name2,
          as: "input",
          type: "hidden",
...
var ListboxOption = (0, import_vue18.defineComponent)({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    let selected = (0, import_vue18.computed)(() => match(api.mode.value, {
      [0 /* Single */]: () => api.compare((0, import_vue18.toRaw)(api.value.value), (0, import_vue18.toRaw)(props.value)),
      [1 /* Multi */]: () => (0, import_vue18.toRaw)(api.value.value).some((value) => api.compare((0, import_vue18.toRaw)(value), (0, import_vue18.toRaw)(props.value)))
    }));
    let isFirstSelected = (0, import_vue18.computed)(() => {
      return match(api.mode.value, {
        [1 /* Multi */]: () => {
          ...
          return ((_a = api.options.value.find((option) => currentValues.some((value) => api.compare((0, import_vue18.toRaw)(value), (0, import_vue18.toRaw)(option.dataRef.value))))) == null ? void 0 : _a.id) === id2;
        },
...
var Popover = (0, import_vue20.defineComponent)({
  ...
  setup(props, { slots, attrs, expose }) {
    ...
    let beforePanelSentinel = (0, import_vue20.ref)(null);
    let afterPanelSentinel = (0, import_vue20.ref)(null);
    let panel = (0, import_vue20.ref)(null);
    let ownerDocument = (0, import_vue20.computed)(() => getOwnerDocument(internalPopoverRef));
    let isPortalled = (0, import_vue20.computed)(() => {
      if (!dom(button))
        return false;
      if (!dom(panel))
        return false;
...
var PopoverButton = (0, import_vue20.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    return () => {
      ...
      return (0, import_vue20.h)(import_vue20.Fragment, [
        render({
        ...
        visible && !isWithinPanel && api.isPortalled.value && (0, import_vue20.h)(Hidden, {
          id: sentinelId,
          features: 2 /* Focusable */,
          as: "button",
          type: "button",
...
var PopoverPanel = (0, import_vue20.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    return () => {
      ...
      return (0, import_vue20.h)(import_vue20.Fragment, [
        visible.value && api.isPortalled.value && (0, import_vue20.h)(Hidden, {
...
var RadioGroup = (0, import_vue22.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    let api = {
      ...
      containsCheckedOption: (0, import_vue22.computed)(() => options.value.some((option) => api.compare((0, import_vue22.toRaw)(option.propsRef.value), (0, import_vue22.toRaw)(props.modelValue)))),
      compare(a, z) {
        return a === z;
      },
      change(nextValue) {
        ...
        if (props.disabled)
          return false;
        if (api.compare((0, import_vue22.toRaw)(value.value), (0, import_vue22.toRaw)(nextValue)))
          return false;
        let nextOption = (_a = options.value.find((option) => api.compare((0, import_vue22.toRaw)(option.propsRef.value), (0, import_vue22.toRaw)(nextValue)))) == null ? void 0 : _a.propsRef;
    ...
    return () => {
      ...
      return (0, import_vue22.h)(import_vue22.Fragment, [
        ...name != null && modelValue != null ? objectToFormEntries({ [name]: modelValue }).map(([name2, value2]) => (0, import_vue22.h)(Hidden, compact({
          features: 4 /* Hidden */,
          key: name2,
          as: "input",
          type: "hidden",
...
var RadioGroupOption = (0, import_vue22.defineComponent)({
  ...
  setup(props, { attrs, slots, expose }) {
    ...
    let checked = (0, import_vue22.computed)(() => api.compare((0, import_vue22.toRaw)(api.value.value), (0, import_vue22.toRaw)(props.value)));
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    return () => {
      ...
      return (0, import_vue23.h)(import_vue23.Fragment, [
        name != null && modelValue != null ? (0, import_vue23.h)(Hidden, compact({
          features: 4 /* Hidden */,
          as: "input",
          type: "checkbox",
          hidden: true,
...
var FocusSentinel = (0, import_vue24.defineComponent)({
  ...
  setup(props) {
    ...
    return () => {
      if (!enabled.value)
        return null;
      return (0, import_vue24.h)(Hidden, {
        as: "button",
        type: "button",
        features: 2 /* Focusable */,
        onFocus(event) {
  ...
  setup(props, { slots, attrs, emit }) {
    ...
    return () => {
      ...
      return (0, import_vue25.h)(import_vue25.Fragment, [
        tabs.value.length <= 0 && (0, import_vue25.h)(FocusSentinel, {
          onFocus: () => {
