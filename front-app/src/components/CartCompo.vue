<template>
    <!-- component -->
    <div class="flex items-center justify-center py-8 mx-8">
        <!--  
  ...
  -->
        <div class="w-full  z-10 right-0 h-full  transform translate-x-0 transition ease-in-out duration-700"
            ...
            <div class="flex  lg:flex-row flex-col" id="cart">
                <div class=" w-full lg:px-8 lg:py-14 md:px-6 px-4 md:py-8 py-4 bg-white dark:bg-gray-800 overflow-y-hidden overflow-x-hidden lg:h-screen h-auto"
                    id="scroll">
                    ...
                    <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
                        ...
                        <div class="md:pl-3 md:w-8/12 2xl:w-3/4 flex flex-col justify-center">
                            ...
                            <div class="flex items-center justify-between w-full pt-1">
                                <p class="text-base font-black leading-none text-gray-800 dark:text-white">{{$store.state.product.name}}</p>
                            ...
                            <p class="text-xs leading-3 text-gray-600 dark:text-white pt-2">{{$store.state.product.description}} </p>
                            <p class="text-xs leading-3 text-gray-600 dark:text-white py-4">Color: Black</p>
                            <p class="w-96 text-xs leading-3 text-gray-600 dark:text-white">Category: {{$store.state.product.category}}</p>
                            <div class="flex items-center justify-between pt-5">
                                <div class="flex itemms-center">
                                    <p class="text-xs leading-3 underline text-gray-800 dark:text-white cursor-pointer">
                                        Add to favorites</p>
                                    <a href="#" class="text-xs leading-3 underline text-red-500 pl-5 cursor-pointer">Remove</a>
                                    
                                </div>
                                <p class="text-base font-black leading-none text-gray-800 dark:text-white">${{$store.state.product.price}}</p>
                            </div>
                        </div>
                    </div>
        <!-- <div class="md:flex items-strech py-8 md:py-10 lg:py-8 border-t border-gray-50">
